class StudentsController < ApplicationController
  ...
  def create
    ...
    if @student.save
      redirect_to course_students_path(course_id), notice: 'Student was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @student.update(student_params)
      redirect_to course_students_path(course_id), notice: 'Student was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @student.destroy
    redirect_to course_students_path(course_id), notice: 'Student was successfully destroyed.'
  end
private
  def courses
    @courses ||= Course.all
